...
function Navbar({ cartProductQuantity, setCartProductQuantity }) {
		...
		<header>
			<div className='container-lg flex primary-header'>
				<div className='flex navbar-container'>
					<div onClick={handleMenuToggle} className='menu-icon' aria-expanded='false'></div>
					...
					<nav>
						...
						{openMenu && (
							<div className='navbar-backdrop' onClick={handleClickOutsideMenu}></div>
						)}
					</nav>
				</div>
